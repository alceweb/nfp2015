...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 class="TitoloVetrina">Gestione forms</h1>
    <table>
        <tr>
            <td style="height:30px">
                <h1 style="color:green">Aggiungi Form</h1>
                <asp:FileUpload ID="FileUpload1" runat="server" /><br />
                <asp:Button ID="Button1" runat="server" Text="Upload" OnClick="Button1_Click" />
                <asp:Label ID="LblUploadOk" runat="server"></asp:Label>
                <asp:Label ID="LblUploadkO" runat="server"></asp:Label>
                <hr />
                <h1 style="color:red">Cancella Form</h1>
                <asp:ListBox ID="lb1" runat="server"></asp:ListBox>
                <br />
                <asp:Button ID="Button2" OnClick="Button2_Click" runat="server" Text="Scegli form da eliminare" />
                <asp:Button ID="btnDelete" OnClick="btnDelete_Click" OnClientClick='return confirm("Stai cancellando la form selezionata. Continuare?")' runat="server"  Text="Elimina" />
