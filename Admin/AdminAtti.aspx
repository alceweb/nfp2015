<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AdminAtti.aspx.cs" Inherits="Admin_AdminAtti" %>
    ...
    <table>
        <tr>
            <td style="height:30px">
                <h1 style="color:green">Aggiungi documenti</h1>
                ...
                <asp:Button ID="btnDelete" OnClick="btnDelete_Click" OnClientClick='return confirm("Stai cancellando il documento selezionato. Continuare?")' runat="server"  Text="Elimina" />
